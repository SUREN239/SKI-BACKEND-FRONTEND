...
import { MdMenu } from 'react-icons/md'; // Importing MdMenu icon from react-icons/md
import logo from '../assets/logo.png';
import backgroundImage from '../assets/pg.jpeg';

const Selectform = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const { college } =  location.state || { college: 'SKCT' };
    ...
    <div style={styles.background}>
      <div style={styles.container}>
        ...
        <div style={styles.body}>
          <span style={styles.selectedCollegeText}>Welcome to {college}</span>
